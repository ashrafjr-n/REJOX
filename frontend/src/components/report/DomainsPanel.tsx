      ...
      {domains.length === 0 ? (
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {domains.map((d) => (
            <div
              key={d.domain}
              className="flex flex-col rounded-lg border border-line bg-surface-0 p-4"
            >
              ...
              {d.rnNotes && (
                <p className="mt-2 border-t border-line/60 pt-2 text-[12px] leading-relaxed text-ink-3">
