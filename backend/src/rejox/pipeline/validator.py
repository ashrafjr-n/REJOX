...
is spawned directly** — all of them go through ``rejox.pipeline.sandbox``, which
...
from rejox.pipeline.sandbox import SandboxPolicy
from rejox.models.validation import (
    Diagnostic,
    MappedDiagnostic,
    StageResult,
    ValidatedScores,
