...
from rejox.models.jobs import MigrationError, MigrationEventData, MigrationResult
...
def _nav_ui_summary(report: AnalysisReport, kg: KnowledgeGraph):
    from rejox.ai.navigation import NavLinkSummary, NavUiSummary
...
def _seed_offline_shape(provider: Any, routes: list, nav_ui: Any) -> None:
    ...
    from rejox.ai.navigation import shape_prompt
...
def _decide_navigator_shape(
    ...
    from rejox.ai.navigation import infer_navigator_shape
