...
from rejox.models.validation import MappedDiagnostic, ValidationResult
from rejox.pipeline.validator import map_diagnostics, validate_project
...
def _apply_line(path: Path, line_no: int, new_line: str) -> tuple[bool, str]:
    ...
    """
    from rejox.pipeline.transformer import TransformerError, check_syntax
