...
Produced by ``rejox/pipeline/emit.py``: the Deterministic Transformer applied to
...
Keep in sync with ``rejox/pipeline/emit.py``.
"""
...
from rejox.models.transformation import TransformWarning, UnhandledItem
